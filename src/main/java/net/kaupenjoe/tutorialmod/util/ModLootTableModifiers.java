        ...
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            ...
            if(JUNGLE_TEMPLE_ID.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .conditionally(RandomChanceLootCondition.builder(1f)) // Drops 100% of the time概率
                        .with(ItemEntry.builder(ModItems.METAL_DETECTOR))//什么物品
                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0f, 1.0f)).build());//几个到几个
